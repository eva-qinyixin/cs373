...
def build_vocab(filepath, vocab_size=10000):
    ...
    #print(examples[0])
    #print('len examples[0]: %d',len(examples[0]))
    ...
    #print('vocab_dict:%d',len(vocab_dict))
    #print
    vocab_list = []
    ...
    #print(freq_sorted_vocab) 
    pruned_vocab = freq_sorted_vocab[:vocab_size-3]
    #print( 'len of pruned_vocab: %d',len(pruned_vocab) )
    #print(vocab)
