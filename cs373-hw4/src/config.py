...
parser.add_argument('--num_iter', type=int, default=10, help='Number of iterations to be run for training')
...
parser.add_argument('--la', type=float, default=None, help='Regularization')
